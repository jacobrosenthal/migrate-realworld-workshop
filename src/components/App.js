      ...
      return (
        <div>
          <Header
            ...
            <Switch>
            <Route exact path="/" render={(props) =>  <Home {...props} appName={this.props.appName} token={this.props.token}  />} />
            ...
            <Route path="/@:username" render={(props) => <Profile {...props}  currentUser={this.props.currentUser}/>} />
            </Switch>
        </div>
      );
    }
